...
if populate_db:  # populating the database
    ...
    # Problems
    Problem.objects.create(name='1 - La chaussette',
    ...
    Participant.objects.create(name='Henri', surname='Riant', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=France, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Jean', surname=u'Valjeané', gender='M', email='toto@toto.com',
                               birthdate='1900-01-31', team=France, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Paul', surname='DePaul', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=France, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Hank', surname='Friesch', gender='M', email='toto@toto.com',
                               birthdate='1900-01-31', team=Germany, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Angela', surname='Heinz', gender='F', email='toto@toto.com',
                               birthdate='1900-01-31', team=Germany, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Max', surname='Kolz', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=Germany, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Ivan', surname='Valogray', gender='M', email='toto@toto.com',
                               birthdate='1900-01-31', team=Russia, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Andrii', surname='Kushkin', gender='M', email='toto@toto.com',
                               birthdate='1900-01-31', team=Russia, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Katerina', surname='Ivanov', gender='F', email='toto@toto.com',
                               birthdate='1900-01-31', team=Russia, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Yao', surname='Zhe', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=China, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Bao', surname='Bounni', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=China, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Yu', surname='Weiwei', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=China, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Marcellos', surname='Ramon', gender='M', email='toto@toto.com',
                               birthdate='1900-01-31', team=Spain, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Caterina', surname='Oleole', gender='F', email='toto@toto.com',
                               birthdate='1900-01-31', team=Spain, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Jose', surname='Dias', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=Spain, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Tassos', surname='Spagettos', gender='M', email='toto@toto.com',
                               birthdate='1900-01-31', team=Greece, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)

    Participant.objects.create(name='Leos', surname='Homere', gender='M', email='toto@toto.com', birthdate='1900-01-31',
                               team=Greece, role='TM', passport_number='ASDFG123', affiliation='Trololo University',
                               veteran=False, diet='NO', tourism='TOURISM_0', shirt_size='M', check_in=False)

    Participant.objects.create(name='Laylas', surname='Minas', gender='F', email='toto@toto.com',
                               birthdate='1900-01-31', team=Greece, role='TM', passport_number='ASDFG123',
                               affiliation='Trololo University', veteran=False, diet='NO', tourism='TOURISM_0',
                               shirt_size='M', check_in=False)
    ...
    # Physics Fights
    PhysicsFight.objects.create(round_number=1, fight_number=1, room=Room1, reporter=Part1F, opponent=Part2G,
                                reviewer=Part1R, problem_presented=Problem1)
    PhysicsFight.objects.create(round_number=1, fight_number=2, room=Room1, reporter=Part2R, opponent=Part2F,
                                reviewer=Part1G, problem_presented=Problem2)
    PhysicsFight.objects.create(round_number=1, fight_number=3, room=Room1, reporter=Part3G, opponent=Part3R,
                                reviewer=Part1F, problem_presented=Problem3)

    PhysicsFight.objects.create(round_number=1, fight_number=1, room=Room2, reporter=Part1C, opponent=Part2E,
                                reviewer=Part1S, problem_presented=Problem4)
    PhysicsFight.objects.create(round_number=1, fight_number=2, room=Room2, reporter=Part2S, opponent=Part2C,
                                reviewer=Part1E, problem_presented=Problem5)
    PhysicsFight.objects.create(round_number=1, fight_number=3, room=Room2, reporter=Part3E, opponent=Part3S,
                                reviewer=Part1C, problem_presented=Problem6)

    PhysicsFight.objects.create(round_number=2, fight_number=1, room=Room1, reporter=Part1C, opponent=Part3R,
                                reviewer=Part1F, problem_presented=Problem7)
    PhysicsFight.objects.create(round_number=2, fight_number=2, room=Room1, reporter=Part2R, opponent=Part2F,
                                reviewer=Part2C, problem_presented=Problem8)
    PhysicsFight.objects.create(round_number=2, fight_number=3, room=Room1, reporter=Part3F, opponent=Part3C,
                                reviewer=Part1R, problem_presented=Problem9)

    PhysicsFight.objects.create(round_number=2, fight_number=1, room=Room2, reporter=Part3E, opponent=Part2S,
                                reviewer=Part3G, problem_presented=Problem7)
    PhysicsFight.objects.create(round_number=2, fight_number=2, room=Room2, reporter=Part2G, opponent=Part2E,
                                reviewer=Part1S, problem_presented=Problem8)
    PhysicsFight.objects.create(round_number=2, fight_number=3, room=Room2, reporter=Part2S, opponent=Part1G,
                                reviewer=Part1E, problem_presented=Problem9)
