...
def soon(request):
    return render(
        request,
        f"{params.instance_name}/bebacksoon.html",
        {
            "params": params,
        },
    )
...
def participants_export(request):
    ...
    return render(
        request,
        f"{params.instance_name}/participants_export.html",
        {
            "participants": participants,
            "params": params,
        },
...
def export_csv_ranking_timeline(request):
    ...
    for pf_number in selective_fights_and_semifinals:
        ...
        writer.writerow(
            (
                [f"{params.fights['names'][pf_number - 1]} | Bonuses"]
                + [previous_scores[team] for team in allteams]
            )
        )
...
def jury_export(request):
    ...
    return render(
        request,
        f"{params.instance_name}/listing_jurys.html",
        {
            "jurys": jurys,
        },
    )
...
def jury_export_web(request):
    ...
    return render(
        request,
        f"{params.instance_name}/listing_jurys_web.html",
        {
            "jurys": jurys,
        },
    )
...
def verify_all(request):
    ...
    return render(
        request,
        f"{params.instance_name}/verify_all.html",
        {
            "params": params,
...
def rounds(request):
    ...
    render_data = {
        ...
        "selective_fight_names": list(
            zip(selective_fights, params.fights["names"][: params.npf])
        ),
...
@user_passes_test(
    ninja_test, redirect_field_name=None, login_url=f"/{params.instance_name}/soon"
)
@cache_page(cache_duration)
def physics_fight_detail(request, pfid):
    ...
    return render(
        request,
        f"{params.instance_name}/physics_fight_detail.html",
        {
            "params": params,
