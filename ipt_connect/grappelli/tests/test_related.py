...
class RelatedTests(TestCase):
    ...
    def test_related_lookup(self):
        ...
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=1&app_label=grappelli&model_name=category'
        )
        ...
        # wrong object_id
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=10000&app_label=grappelli&model_name=category'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=1&app_label=grappelli&model_name=category&query_string=id__gte=99'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=100&app_label=grappelli&model_name=category&query_string=id__gte=99'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=1&app_label=grappelli&model_name=category&query_string=name__icontains=99:id__gte=99'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=100&app_label=grappelli&model_name=category&query_string=name__icontains=99:id__gte=99'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=1&app_label=grappelli&model_name=entry'
        )

        self.assertEqual(response.status_code, 200)
        self.assertJSONEqual(response.content.decode('utf-8'), [{"value": "1", "label": "Entry Superuser"}])
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=2&app_label=grappelli&model_name=entry'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=1&app_label=false&model_name=false'
        )

        self.assertEqual(response.status_code, 200)
        self.assertJSONEqual(response.content.decode('utf-8'), [{"value": None, "label": ""}])
        response = self.client.get(
            f'{reverse("grp_related_lookup")}?object_id=&app_label=false&model_name=false'
        )
    ...
    def test_m2m_lookup(self):
        ...
        # ok (single)
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=1&app_label=grappelli&model_name=category'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=10000&app_label=grappelli&model_name=category'
        )
        ...
        # ok (multiple)
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=1,2,3&app_label=grappelli&model_name=category'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=1,10000,3&app_label=grappelli&model_name=category'
        )
        ...
        # filtered queryset (single filter) fails
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=1,2,3&app_label=grappelli&model_name=category&query_string=id__gte=99'
        )
        ...
        # filtered queryset (single filter) works
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=1,2,3&app_label=grappelli&model_name=category&query_string=id__lte=3'
        )
        ...
        # filtered queryset (multiple filters) fails
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=1,2,3&app_label=grappelli&model_name=category&query_string=name__icontains=99:id__gte=99'
        )
        ...
        # filtered queryset (multiple filters) works
        response = self.client.get(
            f'{reverse("grp_m2m_lookup")}?object_id=1,2,3&app_label=grappelli&model_name=category&query_string=name__icontains=Category:id__lte=3'
        )
    ...
    def test_autocomplete_lookup(self):
        ...
        # term not found
        response = self.client.get(
            f'{reverse("grp_autocomplete_lookup")}?term=XXXXXXXXXX&app_label=grappelli&model_name=category'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_autocomplete_lookup")}?term=Category No 99&app_label=grappelli&model_name=category'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_autocomplete_lookup")}?term=Category&app_label=grappelli&model_name=category&query_string=id__gte=99'
        )
        ...
        response = self.client.get(
            f'{reverse("grp_autocomplete_lookup")}?term=Category&app_label=grappelli&model_name=category&query_string=name__icontains=99:id__gte=99'
        )
